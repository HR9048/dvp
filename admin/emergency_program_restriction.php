...
$rQuery = "
SELECT depot_id, emergency_program_update_days
...
while ($row = $rRes->fetch_assoc()) {
    $restrictionData[$row['depot_id']] = $row['emergency_program_update_days'];
}
?>

<div class="container mt-4">
    <h3 class="text-center mb-3">
        Emergency Program Restriction Days (Edit Date Only)
    </h3>
    ...
    $(".updateBtn").click(function() {
        ...
        $.ajax({
            ...
            data: {
                ...
                emergency_program_update_days: daysVal,
                action: "update_emergency_program_restriction"
            },
            dataType: "json",
