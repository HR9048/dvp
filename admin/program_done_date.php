...
$rQuery = "
SELECT depot_id, program_update_days
...
while ($row = $rRes->fetch_assoc()) {
    $restrictionData[$row['depot_id']] = $row['program_update_days'];
}
?>

<div class="container mt-4">
    <h3 class="text-center mb-3">
        Depot Program Restriction (Edit Date Only)
    </h3>
...
$(".updateBtn").click(function () {
    ...
    $.ajax({
        ...
        data: {
            ...
            program_update_days: daysVal,
            action: "update_program_update_days"
        },
        dataType: "json",
