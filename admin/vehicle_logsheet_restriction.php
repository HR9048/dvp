...
$rQuery = "
SELECT depot_id, vehicle_logsheet_days
...
while ($row = $rRes->fetch_assoc()) {
    $restrictionData[$row['depot_id']] = $row['vehicle_logsheet_days'];
}
?>

<div class="container mt-4">
    <h3 class="text-center mb-3">
        Vehicle Logsheet Restriction Days (Edit Date Only)
    </h3>
    ...
    $(".updateBtn").click(function() {
        ...
        $.ajax({
            ...
            data: {
                ...
                vehicle_logsheet_days: daysVal,
                action: "update_vehicle_logsheet_days"
            },
            dataType: "json",
