...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->fetch()) {
        ...
        echo '<button type="submit" id="submitBtnchange" class="btn btn-primary">Submit</button>';
        echo '</div>';
    } else {
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.get("http://117.251.26.11:8880/dvp/includes/data.php", { division: division, depot: depot }, function (response) {
        ...
        $.get("http://117.251.26.11:8880/dvp/database/private_emp_api.php", { division: division, depot: depot }, function (response) {
