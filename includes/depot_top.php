                                    ...
                                    <?php if ($_SESSION['TYPE'] == 'DEPOT' && $_SESSION['JOB_TITLE'] == 'Bunk' || $_SESSION['JOB_TITLE'] == 'DM') { ?>
                                        <li class="nav-item">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li><a class="dropdown-item" href="depot_kmpl.php">Add Depot KMPL</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="depot_route_kmpl.php">Add Vehicle
                                                            KMPL</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <?php if ($_SESSION['TYPE'] == 'DEPOT' && $_SESSION['JOB_TITLE'] == 'T_INSPECTOR') { ?>
                                                        <li><a class="dropdown-item"
                                                                href="depot_inspector_schedule_d.php">Update Schedule</a></li>
                                                        <li><a class="dropdown-item" href="depot_add_schedule.php">Add
                                                                Schedule</a></li>
                                                        <li><a class="dropdown-item"
                                                                href="depot_scheduel_actinact.php">Modify/Active/Inactive
                                                                Schedule</a>
                                                        </li>
                                                    <?php } ?>
                                                    <?php if ($_SESSION['TYPE'] == 'DEPOT' && $_SESSION['JOB_TITLE'] == 'Mech') { ?>
                                                        <li><a class="dropdown-item" href="depot_schedule_b.php">Update
                                                                Schedule</a></li>
                                                    <?php } ?>
                                                    <?php if ($_SESSION['TYPE'] == 'DEPOT' && $_SESSION['JOB_TITLE'] == 'DM') { ?>
                                                        <li><a class="dropdown-item"
                                                                href="depot_inspector_schedule_d.php">Update Schedule(crew)</a>
                                                        </li>
                                                        <li><a class="dropdown-item" href="depot_schedule_b.php">Update
                                                                Schedule(Bus)</a></li>
                                                        <li><a class="dropdown-item" href="depot_add_schedule.php">Add
                                                        ...
                                                        <li><a class="dropdown-item"
                                                                href="depot_scheduel_actinact.php">Modify/Active/Inactive
                                                                Schedule</a></li>
                                                        <li><a class="dropdown-item" href="depot_schedule_cancel.php">Schedule
                                                                Cancelation</a></li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
                                        ...
                                        <li class="nav-item">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    ...
                                                    <li><a class="dropdown-item" href="depot_addp_emp.php">Add Private
                                                            Employee</a></li>
                                                    <li><a class="dropdown-item" href="depot_manp_emp.php">Manage Private
                                                            Employee</a></li>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <?php if ($_SESSION['TYPE'] == 'DEPOT' && $_SESSION['JOB_TITLE'] == 'Mech') { ?>
                                                        ...
                                                        <li><a class="dropdown-item" href="depot_vehicle_deputation.php">Add
                                                                Vehicel Deputation</a></li>
                                                        <li><a class="dropdown-item" href="depot_veh_dep_monitor.php">Deputation
                                                                Monitor</a></li>
                                                    <?php }
                                                    if ($_SESSION['TYPE'] == 'DEPOT' && $_SESSION['JOB_TITLE'] == 'T_INSPECTOR') { ?>
                                                        <li><a class="dropdown-item" href="depot_crew_deputation.php">Add Crew
                                                                Deputation</a></li>
                                                        <li><a class="dropdown-item"
                                                                href="depot_crew_dep_monitor.php">Deputation Monitor</a></li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
                                        </li>
                                                    ...
                                                    if ($_SESSION['TYPE'] == 'DEPOT' && ($_SESSION['JOB_TITLE'] == 'Mech' || $_SESSION['JOB_TITLE'] == 'DM')) { ?>
                                                        <li class="dropdown-submenu">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="depot_fleet_utilization_report.php">Fleet Utilization Report</a></li>
                                            ...
                                            <div class="dropdown">
                                                <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton1"
                                                    ...
                                                    <?php if ($total_count > 0) { ?>
                                                        <span
                                                            class="badge badge-success badge-counter"><?php echo $total_count; ?></span>
                                                    <?php } ?>
                                                </button>
                        ...
                        <div>
                            <div class="small text-gray-500">No Requests</div>
                                                    ...
                                                    <a class="dropdown-item text-center small text-gray-500"
                                                        href="depot_veh_dep_monitor.php">Show All Requests</a>
                                                </div>
                                            </div>
                                        </li>
                                    <?php }
                 ...
                 GROUP BY `token_number`";
                        ...
                        <div>
                            <div class="small text-gray-500">No Requests</div>
                                                    ...
                                                    <a class="dropdown-item text-center small text-gray-500"
                                                        href="depot_crew_dep_monitor.php">Show All Requests</a>
                                                </div>
                                            </div>
                                        </li>
                                    <?php } ?>
