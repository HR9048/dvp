<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  style="text-decoration: none; font-size: 18px; font-weight: bold;" href="division.php">
        
        <div class="sidebar-brand-text mx-3">Home</div>
      </a>
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  style="text-decoration: none; font-size: 18px; font-weight: bold;" href="division_ORP.php">
        
        <div class="sidebar-brand-text mx-3">Daily Vehical Position</div>
      </a>
