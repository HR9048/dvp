      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="emp_transac.php?action=add">          
              ...
              <div class="form-group">
                <select class="form-control" id="DIVISION" placeholder="division" name="division" required></select>
              </div>
              <div class="form-group">
                <select class="form-control" id="DEPOT" placeholder="depot" name="depot" required></select>
              </div>
              <hr>
            <button type="submit" class="btn btn-success"><i class="fa fa-check fa-fw"></i>Save</button>
            <button type="reset" class="btn btn-danger"><i class="fa fa-times fa-fw"></i>Reset</button>
