                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="bus_number" name="bus_number" required>
                                ...
                                $query = "SELECT BUS_NUMBER FROM bus_registration 
          UNION
          SELECT bus_number FROM bus_scrap_data WHERE order_date >  ?";
        ...
        <script>
            ...
            $(document).ready(function() {
                $('#bd_form').on('submit', function(e) {
                    ...
                    formData += '&action=insert_bd_data_co'; // Add action parameter
