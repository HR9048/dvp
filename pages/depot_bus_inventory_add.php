...
?>
    <div class="container mt-4" style="width:80%;">
        ...
        <form id="busForm">
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-control" id="bus_number" name="bus_number" required>
                        ...
                        <?php
                        $q = mysqli_query($db, "SELECT bus_number FROM bus_registration WHERE division_name = '$division_id' AND depot_name = '$depot_id' AND NOT EXISTS (SELECT 1 FROM bus_inventory WHERE bus_inventory.bus_number = bus_registration.bus_number AND inventory_date = '2025-03-31');");
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="date_of_fc" class="form-label">Last FC date</label>
                    <input type="date" id="date_of_fc" name="date_of_fc" class="form-control" max="2025-03-31" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="fire_extinguisher_total_kg" name="fire_extinguisher_total_kg" required>
                </div>
    ...
    <script>
        ...
        document.getElementById('date_of_fc').addEventListener('change', function() {
            ...
            if (selectedDate > maxDate) {
                Swal.fire({
                    icon: 'error',
                    title: 'Invalid Date',
                    text: 'Date should not be greater than 31-03-2025',
        ...
        function submitbusinventory() {
            ...
            if (dateOfRC > currentDate) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Invalid Date',
                    text: 'Date of RC cannot be in the future.',
                    confirmButtonColor: '#3085d6'
                });
                return;
            }
