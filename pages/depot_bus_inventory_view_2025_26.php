...
LEFT JOIN 2025_26_battery_master bm1 ON bi.battery_1_id = bm1.id
LEFT JOIN 2025_26_battery_master bm2 ON bi.battery_2_id = bm2.id
WHERE bi.depot_id = '$depot_id' AND bi.division_id = '$division_id'";
    ...
    <script>
        function viewDetails(id) {
            $.ajax({
                ...
                type: 'POST',
                data: {
                    action: 'get_bus_details_for_inventory_view_2025_26',
                    id: id
                },
