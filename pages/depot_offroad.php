...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    <?php } elseif ($userType == 'DEPOT') {
        ...
        if ($_SESSION['JOB_TITLE'] == 'Bunk') {
            ...
            // Check if today's data is submitted in dvp_data table for the logged-in division and depot
        ...
        // Redirect users with other account types to another page
        ?>
        <script type="text/javascript">
            alert("Restricted Page! Only depot accounts are allowed to access this page.");
            window.location = "logout.php"; // Redirect to another page for non-depot accounts
        </script>
        <?php
    }
}
