...
if ($_SESSION['TYPE'] == 'DEPOT' && ($_SESSION['JOB_TITLE'] == 'Mech' || $_SESSION['JOB_TITLE'] == 'DM')) {
    ...
    $bus_query = "SELECT bus_number, make, emission_norms, bus_progressive_km_31032025, model_type FROM bus_registration WHERE depot_name = $depot_id AND division_name = $division_id";
...
?>
    ...
    <h2>Bus Program KM as on 31-06-2025</h2>
