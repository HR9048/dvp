...
<div class="container mt-5">
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $driver_tokens = [$row['driver_token_1_1'], $row['driver_token_1_2'], $row['driver_token_1_3'], $row['driver_token_2_1'], $row['driver_token_2_2'], $row['driver_token_2_3']];
            $half_reliever_tokens = [$row['half_releiver_token_1'], $row['half_releiver_token_2']];
            ...
            echo '</td>
                <td>';
            foreach ($half_reliever_tokens as $half_reliever_token) {
                if (!empty($half_reliever_token)) {
                    echo $half_reliever_token . '<br>';
                }
            }
            echo '</td>
