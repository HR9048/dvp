...
$insert_sql = "INSERT INTO bus_scrap_data (bus_number, make, emission_norms, depot, division, doc, wheel_base, chassis_number, bus_category, bus_sub_category, seating_capacity, bus_body_builder, bus_username, bus_submitdatetime, transfer_order_no, order_date, username, submitdatetime) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
$insert_stmt->bind_param(
    ...
    $username, 
    $submitdatetime // Ensure this is in 'YYYY-MM-DD' format if it's a date
);
