            ...
            <div class="modal-body">
                ...
                <form id="busForm" method="post" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="defect_notice_date" name="defect_notice_date" class="form-control" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" id="status_updated_datetime" name="status_updated_datetime" class="form-control">
                    </div>
