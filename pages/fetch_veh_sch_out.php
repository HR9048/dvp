...
try {
    ...
    $sql = "SELECT driver_1_pf, driver_2_pf, conductor_pf_no FROM sch_veh_out WHERE schedule_status in (1,2,6,7) AND division_id = $division_id and depot_id= $depot_id";
    $result = $db->query($sql);
