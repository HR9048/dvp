...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if ($Aa == 'DEPOT') {
        ...
        <script type="text/javascript">
            ...
            alert("Restricted Page! You will be redirected to the division page");
...
<marquee behavior="scroll" direction="left">
    <h4 class="red">You are attending to transfer vehicle from one division depot to another division depot within your Corporation</h4>
</marquee>
